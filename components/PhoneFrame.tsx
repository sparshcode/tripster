...
export function PhoneFrame({ children }: { children: ReactNode }) {
  return (
    <div className="phone-backdrop flex min-h-screen items-center justify-center p-4">
      <div
        className="relative w-full rounded-[54px] bg-slate-950 p-[14px] shadow-2xl shadow-indigo-500/40 ring-1 ring-slate-800"
        style={{
          maxWidth: "min(400px, calc((100vh - 32px) * 9 / 19.5))",
        }}
      >
        ...
        <main
          className="relative flex w-full flex-col overflow-hidden rounded-[42px] bg-white"
